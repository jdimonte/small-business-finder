...
class SearchViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, searchDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .businesses:
            vc.isUser = false
            vc.business = BusinessObject(name: businessNames[indexPath.row], phoneNumber: "800-123-4567", busDescription: descriptions[indexPath.row], category: "Food", latCoord: nil, longCoord: nil, websiteLink: nil, following: nil, followers: nil)
        case .users:
            vc.isUser = true
